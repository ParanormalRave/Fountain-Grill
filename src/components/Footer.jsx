    ...
    <footer className="bg-accent text-secondary pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="space-y-4">
          <h3 className="text-2xl font-serif font-bold text-primary">FOUNTAIN GRILL</h3>
          <p className="opacity-70">Serving quality food and warm memories since 1985. Your community's favorite gathering place.</p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 opacity-70">
            <li><Link to="/#honor-flight" className="hover:text-primary transition-colors">Honor Flight</Link></li>
            ...
            <li><Link to="/events" className="hover:text-primary transition-colors">Private Events</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="#" className="bg-primary/20 p-2 rounded-full hover:bg-primary transition-all">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 border-t border-secondary/10 flex flex-col md:flex-row justify-between items-center text-sm opacity-50">
        <p>© 2026 Fountain Grill. All rights reserved.</p>
